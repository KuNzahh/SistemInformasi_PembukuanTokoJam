...
type
  TForm10 = class(TForm)
    ...
    edt5: TEdit;
    ZQuery1: TZQuery;
    dsDetBeli: TDataSource;
    frxDBdetbeli: TfrxDBDataset;
    frxRdetbeli: TfrxReport;
...
begin
ZQuery1.sql.clear;
ZQuery1.sql.Add('insert into detail_beli values(null,"'+edt1.Text+'","'+edt2.text+'","'+edt3.text+'","'+edt4.text+'","'+edt5.text+'")');
ZQuery1.ExecSQL;
...
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('Update detail_beli set beli_id= "'+edt1.Text+'", barang_id = "'+edt2.Text+'", jumlah = "'+edt3.Text+'", harga_beli = "'+edt4.Text+'", total_beli = "'+edt5.Text+'" where id ="'+id+'"');
ZQuery1.ExecSQL;
